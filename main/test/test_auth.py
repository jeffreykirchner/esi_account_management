...
class TestAuth(TestCase):
    ...
    def test_create_account(self):
        ...
        #password
        data = {'action': 'create', 'form_data': [{'name': 'first_name', 'value': 'John'}, {'name': 'last_name', 'value': 'smith'}, {'name': 'email', 'value': 'abc@123.edu'}, {'name': 'organization', 'value': 'College Tech'}, {'name': 'password1', 'value': 'qwerty123'}, {'name': 'password2', 'value': 'qwerty123'}]}
        ...
        data = {'action': 'create', 'form_data': [{'name': 'first_name', 'value': ''}, {'name': 'last_name', 'value': ''}, {'name': 'email', 'value': ''}, {'name': 'organization', 'value': ''}, {'name': 'password1', 'value': ''}, {'name': 'password2', 'value': ''}]}
    ...
    def test_edit_account(self):
        ...
        data = {'action': 'update', 'form_data': [{'name': 'first_name', 'value': 'Adam'}, {'name': 'last_name', 'value': 'Joe'}, {'name': 'email', 'value': 'abc@123.edu'}, {'name': 'organization', 'value': 'Chapman University'}, {'name': 'password1', 'value': ''}, {'name': 'password2', 'value': ''}]}
        ...
        data = {'action': 'update', 'form_data': [{'name': 'first_name', 'value': 'Adam'}, {'name': 'last_name', 'value': 'Joe'}, {'name': 'email', 'value': 'abc@chapman.edu'}, {'name': 'organization', 'value': 'Chapman University'}, {'name': 'password1', 'value': ''}, {'name': 'password2', 'value': ''}]}
        result = json.loads(update_profile(user, data).content.decode("UTF-8"))
        self.assertEqual(result['status'], 'success')
        ...
        data = {'action': 'update', 'form_data': [{'name': 'first_name', 'value': 'Adam'}, {'name': 'last_name', 'value': 'Joe'}, {'name': 'email', 'value': 'abc@chapman.edu'}, {'name': 'organization', 'value': 'Chapman University'}, {'name': 'password1', 'value': 'qwerty11223344'}, {'name': 'password2', 'value': 'qwerty11223344'}]}
        result = json.loads(update_profile(user, data).content.decode("UTF-8"))
        self.assertEqual(result['status'], 'success')
        ...
        data = {'action': 'update', 'form_data': [{'name': 'first_name', 'value': 'Adam'}, {'name': 'last_name', 'value': 'Joe'}, {'name': 'email', 'value': 'abc@chapman'}, {'name': 'organization', 'value': 'Chapman University'}, {'name': 'password1', 'value': ''}, {'name': 'password2', 'value': ''}]}
        result = json.loads(update_profile(user, data).content.decode("UTF-8"))
        #logger.info(result)
        self.assertEqual(result['errors']['email'][0], 'Enter a valid email address.')

        #check valid password
        data = {'action': 'update', 'form_data': [{'name': 'first_name', 'value': 'Adam'}, {'name': 'last_name', 'value': 'Joe'}, {'name': 'email', 'value': 'abc@chapman.edu'}, {'name': 'organization', 'value': 'Chapman University'}, {'name': 'password1', 'value': 'asdfqwert1234'}, {'name': 'password2', 'value': ''}]}
        result = json.loads(update_profile(user, data).content.decode("UTF-8"))
        logger.info(result)
